...
var wsc = {  // worldstarchicken global
  index: 0,  // banner index quasi observer
  inter: 0,  // interval id returned by setInterval
  /* DOM objects */
  ...
  gmapkey: 'AIzaSyDpkWhGUaeVllPoBYwPjMt62ZdF1vCo6xU',  // susu secret
  /* quasi promises */
  date: '',
  latitude: 0,
  longitude: 0,
...
function initMap() {
  ...
  const map = new google.maps.Map(document.getElementById('mapper'), {
    ...
    scrollwheel: false  // must b false! allowing 4 mobile users
  });
  const marker = new google.maps.Marker({
    position: LATLNG,
    map: map,
    title: wsc.location,
    icon: './img/worldstarpointer2.svg'
  });
}
...
function showDiv() {
  ...
  banners[wsc.index].className = 'banner fadein';  // fadein new
